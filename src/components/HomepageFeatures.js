...
const FeatureList = [
    ...
    },
    {
        ...
        description: (
            <>
                本站是基于 <strong>Docusaurus</strong> 搭建的静态站点，目前借助 <strong>Github Actions</strong> 自动构建、部署在 <strong>Github
                Pages</strong>.
            </>
        ),
    },
...
function Feature({src, title, description}) {
    ...
    return (
        ...
        >
            <div
                className={clsx({['shadow--md']:hover, ['shadow--lw']:!hover}, styles.featureItem)}
            >
