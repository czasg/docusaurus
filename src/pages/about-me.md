...
**工作岗位：**后端研发工程师 / 研发组长          
**工作内容：**       
- 负责AVLSDK产品线基建板块**管理工作**，定期向上级汇总、汇报相关事宜
- 负责病毒运营体系维护
- 负责部分遗留旧系统维护

**里程碑事项：**
- 2023年团队扩员至7人，担任**AVLSDK产品线基建板块**负责人
- 2022年团队重构，担任**研发组长**一职，负责团队（4人）日常工作管理与研发质量把控
...
#### **项目难点：**
- 性能要求高，高峰期**超百万QPS**
- 数据一致性要求高，多次查询需要确保结果一致
- 网络环境不稳定。因为数据在公司内部，云服务则部署在第三方云厂商，且公司经常断电😅

#### **项目亮点：**    
* KV-DB 基于 WAL 技术，引入**版本管理**概念，设计**ensure/publish协议**，解决弱网环境下数据可靠性问题，并**申请专利**
...
#### **项目难点：**
- 如何在半小时内扫描完 20w 10T 样本
- 如何使样本存储分布均匀
- 样本使样本扫描时间均匀

#### **项目亮点：**
- 设计 Center、Agent、Scheduler 实现分布式存储能力
