...
**工作方面**：态度积极，责任心强。**不管是不是我的事，经了我的手，就是我的事**。曾多次临时接手遗留瘫痪系统并使其正常运行，属于认真实干的一批人

**学习方面**：喜欢自己造轮子，也喜欢分享。曾组织十余次技术分享，主题包括Docker、Go相关知识。也一直希望身边有很多大佬，可以让我模仿学习~
...
**工作岗位：**后端研发工程师 / 平台技术组Leader          
**工作内容：**       
- 负责内部安全作业平台**管理工作**，定期向上级汇总、汇报相关事宜
- 负责业务基建建设与维护
- 负责核心业务**云查引擎**的研发与维护
- 负责部分老旧系统维护

**主要业绩：**
- 主导内部安全作业平台梳理工作，完成平台可用、可持续迭代、可持续维护的过渡
- 主导第三代云查引擎产品研发与上线，解决异地多活场景下数据不一致问题
- 修复多个内部旧平台，整理并输出相关文档

**里程碑事项：**
- 2022年团队重构，担任**平台技术组Leader**
- 2021年研发**云查引擎**
- 2020年修复多个遗留系统
...
- 负责攻克**字符型验证码识别**。举例：裁判文书网、搜狗微信等
- 承担部分垂直领域爬虫维护

**里程碑事项：**    
- 2020年优秀调薪(30%)，满一年后离职

### 2018.03~2019.03 - 中软国际(实习)
**公司全称：**武汉中软国际科技服务有限公司    
**公司性质：**大型外包公司 / 人员1W+     
**实习岗位：**后端研发工程师            
**工作职责：**       
...
**里程碑事项：**   
- 2019年拒绝**优秀调薪转正**，满一年后离职
- 2018年年底荣获集团**优秀应届生**
- 2018年申请人力外包至**武汉华为研究所**，期望长长见识

### 2014.09~2018.07 - 武科大(本科)
**学校全称：**[武汉科技大学](https://www.wust.edu.cn/)       
**在校专业：**工业工程       
**里程碑事项：**     
- 截止2018年平均成绩绩点(GPA-4.0)**3.78**
- 2018年荣获**优秀毕业生**
- 2018年考研华科计算机失利
- 2017年拒绝本校保研
- 2017年过计算机二级(优秀)，计划转行
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;云查引擎是一款为终端提供云端病毒查询服务的产品，该产品依托于大数据平台赋能，由云查API、KV-DB、云查数据加工等多个模块联动组成。支持快速病毒查杀、秒级上下线规则、定向多元打击等能力。其产品定位于解决终端引擎性能瓶颈、规则更新延迟等问题。      
...
#### **2.项目简介：**    
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;云查引擎是一款为终端提供云端病毒查询服务的产品，该产品依托于大数据平台赋能，由云查API、KV-DB、云查数据加工等多个模块联动组成。支持快速病毒查杀、秒级上下线规则、定向多元打击等能力。其产品定位于解决终端引擎性能瓶颈、规则更新延迟等问题。目前该产品已长期应用于多家合作厂商，高峰期并发量达百万。  
...
#### **3.职责描述：**         
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2021年以后，业务持续上量，而当前云查数据同步方案又存在较大缺陷，导致线上数据频繁更新异常。
基于此背景，由我主导的**新KV-DB**项目于2021年下半年正式启动，旨在解决弱网环境下数据可靠性问题，以保障异地多活场景下的数据最终一致性。      

重点包括：
* 负责新KV-DB的设计与研发，并于2022年上半年正式上线投入使用
* 负责云查数据加工开发与维护
...
#### **1.项目简介：**   
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pywss 框架是一款基于 Python 语言开发的 Web 框架。           
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其最初需求是来源于测试的一个小需求，主要内容就是快速搭建`WebSocket`服务端，以便灵活实现相关功能测试。后期经过多轮迭代，逐渐衍生成了一个独立框架，其特点有：
* 相较于 Flask、Django 等基于 WSGI 标准实现的后端框架，Pywss 直接基于原生 socket 开发，故在性能上有一定优势
* 除了支持插件能力外，原生支持了`WebSocket Upgrade`和`SwaggerUI`等能力
* 支持应用级别的单元测试

[Github项目地址](https://github.com/czasg/pywss)       
